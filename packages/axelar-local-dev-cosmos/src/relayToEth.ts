...
//   await ethereumNetwork.deployToken('Axelar Wrapped aUSDC', 'aUSDC', 6, BigInt(1000));

//   const IERC20 = require('@axelar-network/axelar-gmp-sdk-solidity/artifacts/contracts/interfaces/IERC20.sol/IERC20.json');
//   const usdcAddress = await ethereumNetwork.gateway.tokenAddresses('aUSDC');
//   const usdc = new Contract(usdcAddress, IERC20.abi, ethereumNetwork.userWallets[0]);
...
//   console.log(await ethereumNetwork.provider.getBlockNumber())
//   // TODO
